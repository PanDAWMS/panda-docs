...
The ``model`` field also supports the ``!=`` prefix to exclude a specific GPU model, with optional wildcards
(e.g., ``"model": "!=Tesla P100-SXM2-16GB"`` or ``"model": "!=*P100*"`` to avoid queues with that GPU model).
