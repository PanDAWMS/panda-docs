...
* `type:evgen:100%,type:simul:100%,type:any:0%,priority>500:0%` means that the site accepts `evgen` and `simul`, reject any other types and will also reject tasks
with `currentPriority` above `500`.
