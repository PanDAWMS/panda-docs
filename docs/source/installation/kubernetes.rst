...
.. note::
   ...
   For GitOps-based deployment via ArgoCD — including automatic image updates and the
   developer workflow for testing personal changes — see
   :doc:`kubernetes_gitops`.
